...
def tower_loss(scope):
  ...
  _, risk_diff  = model.exponential_loss(logits, labels, args.bs)
...
#      if step % 1 == 0:
      ...
      batch_num = batch_num + 1
      batch_score, batch_orderable = model_tools.c_index_score_orderable(logits_value, labels_value['survival'],
                                                                         labels_value['censored'])
      ...
      print("The batch C index is: %1.4f" % (batch_CI))
